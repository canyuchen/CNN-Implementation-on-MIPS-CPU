...
CONFIG.WUSER_WIDTH {0} \
  ...
  set mips_cpu_reset_n [ create_bd_port -dir I -type rst mips_cpu_reset_n ]
  ...
  set_property -dict [ list \
CONFIG.ASSOCIATED_BUSIF {mips_cpu_axi_mmio:mips_cpu_axi_mem:user_axi} \
CONFIG.ASSOCIATED_RESET {mips_cpu_reset_n} \
 ] $ps_fclk_clk0
  set ps_user_reset_n [ create_bd_port -dir O -type rst ps_user_reset_n ]
...
CONFIG.C_IS_DUAL {1} \
  ...
  # Create instance: axi_gpio_dnn, and set properties
...
CONFIG.PSU__VIDEO_REF_CLK__ENABLE {0} \
  ...
  connect_bd_intf_net -intf_net axi_gpio_ic_m_8 [get_bd_intf_pins axi4_gpio_ic/M08_AXI] [get_bd_intf_pins axi_gpio_dnn/S_AXI]
  ...
  connect_bd_intf_net -intf_net user_axi [get_bd_intf_ports user_axi] [get_bd_intf_pins mips_axi_ic/S01_AXI]

  # Create port connections
  connect_bd_net -net armv8_ps_fclk_0 [get_bd_ports ps_fclk_clk0] [get_bd_pins arm_axi_ic/ACLK] [get_bd_pins arm_axi_ic/M00_ACLK] [get_bd_pins arm_axi_ic/S00_ACLK] [get_bd_pins axi4_gpio_ic/ACLK] [get_bd_pins axi4_gpio_ic/M00_ACLK] [get_bd_pins axi4_gpio_ic/M01_ACLK] [get_bd_pins axi4_gpio_ic/M02_ACLK] [get_bd_pins axi4_gpio_ic/M03_ACLK] [get_bd_pins axi4_gpio_ic/M04_ACLK] [get_bd_pins axi4_gpio_ic/M05_ACLK] [get_bd_pins axi4_gpio_ic/M06_ACLK] [get_bd_pins axi4_gpio_ic/M07_ACLK] [get_bd_pins axi4_gpio_ic/M08_ACLK] [get_bd_pins axi4_gpio_ic/S00_ACLK] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_gpio_1/s_axi_aclk] [get_bd_pins axi_gpio_2/s_axi_aclk] [get_bd_pins axi_gpio_3/s_axi_aclk] [get_bd_pins axi_gpio_4/s_axi_aclk] [get_bd_pins axi_gpio_5/s_axi_aclk] [get_bd_pins axi_gpio_6/s_axi_aclk] [get_bd_pins axi_gpio_7/s_axi_aclk] [get_bd_pins axi_gpio_dnn/s_axi_aclk] [get_bd_pins axi_uart/s_axi_aclk] [get_bd_pins mips_axi_ic/ACLK] [get_bd_pins mips_axi_ic/M00_ACLK] [get_bd_pins mips_axi_ic/M01_ACLK] [get_bd_pins mips_axi_ic/M02_ACLK] [get_bd_pins mips_axi_ic/S00_ACLK] [get_bd_pins mips_axi_ic/S01_ACLK] [get_bd_pins rst_zynq_mpsoc_99M/slowest_sync_clk] [get_bd_pins zynq_mpsoc/maxihpm0_lpd_aclk] [get_bd_pins zynq_mpsoc/pl_clk0] [get_bd_pins zynq_mpsoc/saxihp0_fpd_aclk]
  ...
  connect_bd_net -net mips_cpu_reset_n [get_bd_ports mips_cpu_reset_n] [get_bd_pins arm_axi_ic/ARESETN] [get_bd_pins arm_axi_ic/M00_ARESETN] [get_bd_pins axi4_gpio_ic/ARESETN] [get_bd_pins axi4_gpio_ic/M00_ARESETN] [get_bd_pins axi4_gpio_ic/M01_ARESETN] [get_bd_pins axi4_gpio_ic/M02_ARESETN] [get_bd_pins axi4_gpio_ic/M03_ARESETN] [get_bd_pins axi4_gpio_ic/M04_ARESETN] [get_bd_pins axi4_gpio_ic/M05_ARESETN] [get_bd_pins axi4_gpio_ic/M06_ARESETN] [get_bd_pins axi4_gpio_ic/M07_ARESETN] [get_bd_pins axi4_gpio_ic/M08_ARESETN] [get_bd_pins axi4_gpio_ic/S00_ARESETN] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_gpio_1/s_axi_aresetn] [get_bd_pins axi_gpio_2/s_axi_aresetn] [get_bd_pins axi_gpio_3/s_axi_aresetn] [get_bd_pins axi_gpio_4/s_axi_aresetn] [get_bd_pins axi_gpio_5/s_axi_aresetn] [get_bd_pins axi_gpio_6/s_axi_aresetn] [get_bd_pins axi_gpio_7/s_axi_aresetn] [get_bd_pins axi_gpio_dnn/s_axi_aresetn] [get_bd_pins axi_uart/s_axi_aresetn] [get_bd_pins mips_axi_ic/ARESETN] [get_bd_pins mips_axi_ic/M00_ARESETN] [get_bd_pins mips_axi_ic/M01_ARESETN] [get_bd_pins mips_axi_ic/M02_ARESETN] [get_bd_pins mips_axi_ic/S00_ARESETN] [get_bd_pins mips_axi_ic/S01_ARESETN]
  ...
  connect_bd_net -net ps_user_reset_n [get_bd_ports ps_user_reset_n] [get_bd_pins rst_zynq_mpsoc_99M/ext_reset_in] [get_bd_pins zynq_mpsoc/pl_resetn0]
  connect_bd_net -net rst_zynq_mpsoc_99M_peripheral_aresetn [get_bd_pins arm_axi_ic/S00_ARESETN] [get_bd_pins rst_zynq_mpsoc_99M/peripheral_aresetn]
  ...
  create_bd_addr_seg -range 0x00001000 -offset 0x80040000 [get_bd_addr_spaces mips_cpu_axi_mem] [get_bd_addr_segs axi_gpio_dnn/S_AXI/Reg] DNN_CTRL
