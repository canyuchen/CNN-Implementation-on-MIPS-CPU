...
set psu_ddr_init_data {
    ...
    mask_write 0XFD070100 0x7F3F7F3F 0x11122413
    ...
    mask_write 0XFD07012C 0x7F1F031F 0x1D07010E
    ...
    mask_write 0XFD080110 0xFFFFFFFF 0x07261008
    ...
    mask_write 0XFD080124 0xFFFFFFFF 0x00381008
...
set psu_peripherals_init_data {
    ...
    mask_write 0XFD1A0100 0x000F007E 0x00000000
		# : RESET BLOCKS
		# : TIMESTAMP
